...
if (empty($servicos)) {
    $servicos = [
        ['nome' => 'Cuidados Domiciliares', 'descricao' => 'Assistência completa no conforto do seu lar.', 'icone' => 'fa-home'],
        ['nome' => 'Acompanhamento de Idosos', 'descricao' => 'Suporte personalizado para idosos.', 'icone' => 'fa-heart'],
        ['nome' => 'Enfermagem Especializada', 'descricao' => 'Cuidados de enfermagem com expertise.', 'icone' => 'fa-user-md']
    ];
}
?>
<!DOCTYPE html>
