        ...
        <div class="container">
            <div class="about-content">
                <div class="text">
                    ...
                    <p>A HomeCare nasceu com o propósito de transformar a forma como as pessoas recebem cuidados de saúde. Percebemos que muitos pacientes e idosos precisam de assistência especializada, mas preferem receber esse cuidado no conforto de suas casas.</p>
                    ...
                    <h3>Nossa Missão</h3>
                    <p>Proporcionar qualidade de vida e bem-estar através de cuidados humanizados, conectando profissionais de saúde a pessoas que precisam de assistência especializada no conforto de suas casas.</p>
                    <h3>Nossa Visão</h3>
        ...
        <div class="container">
            ...
            <div class="values-grid">
                ...
                <div class="value-card">
                    ...
                    <h4>Inovação</h4>
                    <p>Buscamos constantemente novas formas de cuidar melhor.</p>
                </div>
                <div class="value-card">
                    <span class="icon"><i class="fas fa-users"></i></span>
                    <h4>Colaboração</h4>
                    <p>Trabalhamos em equipe para oferecer o melhor cuidado.</p>
                </div>
            </div>
        </div>
    </section>
